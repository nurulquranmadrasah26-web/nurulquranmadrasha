...
## ৬) নতুন হিসাব, কর্জে হাসানা ও প্রকাশকাল

- **কর্জে হাসানা** Super Admin, Admin ও Teacher প্যানেলের নতুন মেনুতে আছে। শিক্ষার্থী
  খুঁজে কর্জের বিবরণ, কর্জদাতা এবং নেওয়া/ফেরতের তারিখ সংরক্ষণ করা যায়। শিক্ষার্থীর
  সক্রিয় User ID মিললে সঙ্গে সঙ্গে ব্যক্তিগত নোটিফিকেশন যায়। ফেরত পাওয়া হিসেবে
  চিহ্নিত করলে সেই নোটিফিকেশন সরিয়ে দেওয়া হয়; রেকর্ডটি history-তে থাকে এবং আয়/ব্যয়
  ledger-এ যোগ হয় না।
- আয়/ব্যয়ের manual রেকর্ডে খাত সংরক্ষণ হয়। আয় ও ব্যয় পেজ থেকে **খাতভিত্তিক
  প্রিন্ট / PDF** চাপলে প্রতিটি খাতের লেনদেন-সংখ্যা ও মোট টাকার পরিষ্কার রিপোর্ট পাওয়া যায়।
  মাসিক ফি, ভর্তি ফি, ডোনেশন, বেতন ও অন্যান্য ব্যয়ের default category যোগ করা হয়েছে।
- খাবার রুটিন এখন reference layout-এর মতো **সকাল / দুপুর / রাত**—এই তিন কলামে
  দেখায়। বাংলা default meal data prefilled থাকে, পুরনো পাঁচ-slot data থাকলেও migration
  নিরাপদে চলে, এবং **প্রিন্ট / PDF** বোতামটি শুধু routine table-ই প্রিন্ট করে।
- Notice ও syllabus/সাজেশন প্রকাশে শুরু এবং শেষ—দুই তারিখ বাধ্যতামূলক। শিক্ষার্থী
  panel-এ মেয়াদ শেষ হলে item আর দেখায় না; class/branch targeting-ও notice-এ প্রয়োগ হয়।
  Syllabus form-এর `ধরন` থেকে একই সময়সীমা ব্যবহার করে **সাজেশন** প্রকাশ করা যায়।
